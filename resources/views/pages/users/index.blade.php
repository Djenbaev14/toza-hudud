                  ...
                  <div class="card-header">
                      <div class="row g-1 justify-content-between p-2" style="background-color: #F9F9FC;border-radius:10px;" >
                        ...
                        <div class="col-lg-3 col-sm-12">
                          <a href="{{route('users.create')}}" class="btn btn-success float-end w-100">
                  ...
                  <div class="card-body">
                      <div class="table-responsive mb-3 ">
                          <table class="table " id="roles-table">
                              <thead>
                                  <tr>
                                      <th scope="col" class="text-nowrap">Аты</th>
                                      <th scope="col" class="text-nowrap">Телефон номер</th>
                                      <th scope="col" class="text-nowrap">Рол Аты</th>
                                      <th scope="col" class="text-nowrap">Филиал</th>
                              ...
                              <tbody>
                                ...
                                <tr class="align-middle" >
                                  ...
                                  <td>
                                      <a href="{{route('users.edit',$user->id)}}" class="btn btn-sm btn-success" style="margin-right: 10px" >
                                        <i class="mdi mdi-pencil  fs-18"></i></a>
