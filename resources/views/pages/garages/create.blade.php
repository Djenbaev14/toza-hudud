          ...
          <div class="col-12">
            <div class="row  justify-content-between p-2" >
              ...
              <div class="col-lg-3 col-sm-12">
                <button class="btn btn-success float-end w-100" data-bs-toggle="modal" data-bs-target="#modalGrid2">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12 mb-3">
                                      ...
                                      <div class="col-lg-4 col-sm-12 mb-3">
                                        ...
                                        <input type="text" name="car_number" class="form-control" oninput="ToUpper(this)" maxlength="8" placeholder="95A123AA" class="form-control form-control-sm">
                                        @error('car_number')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                      </div>
                                      <div class="col-lg-4 col-sm-12  mb-3">
                                        ...
                                        <input type="number" name="manufacturing_year" class="form-control" id="" placeholder="Год выпуска">
                                      ...
                                      <div class="col-lg-4 col-sm-12 mb-3">  
                                        ...
                                        <input type="number" name="current_mileage" class="form-control" id="" placeholder="Текущий пробег">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-4 col-sm-12 mb-3">  
                                        ...
                                        <input type="text" oninput="ToUpper(this)" name="engine_number" class="form-control" id="" placeholder="Двигатель Номер">
                                        @error('engine_number')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                      </div>
                                      <div class="col-lg-4 col-sm-12 mb-3">  
                                        ...
                                        <input type="text" oninput="ToUpper(this)" name="body_number" class="form-control" id="" placeholder="Кузов Номер">
                                        @error('body_number')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                      </div>
                                      <div class="col-lg-4 col-sm-12 mb-3">  
                                        ...
                                        <input type="text" oninput="ToUpper(this)" name="wine_number" class="form-control" id="" placeholder="VIN Номер">
                                      </div>
                                    </div>
                                  </div>
