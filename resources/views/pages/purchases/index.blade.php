              ...
              <div class="card">
                  <div class="card-header">
                      ...
                      <div class="row  justify-content-between p-2" style="background-color: #F9F9FC;border-radius:10px;" >
                        <div class="col-4">
                          <form action="{{ url('/purchases') }}" class="d-flex" method="GET">
                            <input type="search" class="form-control" oninput="this.form.submit()" name="search" value="{{ request('search') }}" placeholder="Поиск"/>
                        </form>
                        </div>
                        <div class="col-8">
                          <a href="{{route('purchases.create')}}" class="btn btn-success float-end mx-2">
                          ...
                          <table class="table " id="roles-table">
                              ...
                              <tbody>
                                ...
                                <tr class="align-middle">
                                  ...
                                  <td>{{number_format(totalSumPurchase($purchase->purchase_product))}} сум</td>
                                  <td></td>
                                  <td>{{$purchase->date}}</td>
                                  <td>
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item d-flex align-items-center" href="{{route('purchases.show',$purchase->id)}}"><i data-feather="eye"></i> &nbsp; &nbsp; <span>Показать</span></a></li>
                                        <li><a class="dropdown-item d-flex align-items-center" href="{{route('purchases.edit',$purchase->id)}}"><i data-feather="edit"></i> &nbsp; &nbsp; <span>Редактировать</span></a></li>
                                        <li><a class="dropdown-item d-flex align-items-center" href="{{route('purchases.destroy',$purchase->id)}}"><i data-feather="trash-2"></i> &nbsp; &nbsp; <span>Удалить</span></a></li>
                                        <li>
                                      </ul>
                                  </td>
                                </tr>
