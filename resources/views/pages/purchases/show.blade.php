                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col">
                        ...
                        <table>
                          ...
                          <tr>
                            <td ><span class="fw-bold">Сумма :</span> {{number_format(totalSumPurchase($purchase->purchase_product))}} сум</td>
                          </tr>
                          <tr>
                            <td><span class="fw-bold">Количество товаров :</span> {{$purchase->purchase_product->count()}}</td>
                          </tr>
                        </table>
                      </div>
                    </div>
                        ...
                        <tbody>
                          @foreach ($purchase->purchase_product as $product)
                            <tr>
                              ...
                              <td>{{number_format($product->quantity)}} сум</td>
