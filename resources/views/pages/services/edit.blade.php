                            ...
                            <form method="POST" action="{{route('services.update',$service->id)}}">
                              ...
                              <div class="row">
                                  <div class="col-12 mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$service->name}}" placeholder="Название" class="form-control ">
                                    @error('name')
                                  ...
                                  <div class="col-12 mb-3">
                                    ...
                                    <input type="number" value="{{$service->price}}"  name="price" placeholder="Цена" class="form-control" id="">
                                    @error('price')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                  </div>
