              ...
              <div class="card">
                  <div class="card-header">
                      <div class="row  justify-content-between p-2" >
                        ...
                        <div class="col-8 ">
                          <a href="{{route('purchase-spare-part.index')}}" class="btn btn-success float-end mx-2">
                            Назад
                          </a>
                        </div>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="POST" action="{{route('purchase-spare-part.store')}}">
                              @csrf
                              <div class="row">
                                <div class="col-4">
                                  <div class="mb-3">
                                    <label class="form-label">Поставщик</label>
                                    <select name="supplier_id" class="form-control" id="single">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="datetime-local" id="current-time" class="form-control" name="date">
                                    @error('date')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                  </div>
                                  ...
                                  <div id="form-container">
                                      ...
                                      <div class="form-row row mb-3">
                                        <div class="col-3">
                                          ...
                                          <select name="product_id[]" class="form-control form-control-sm product-select" >
                                              <option value="" hidden>Выберите</option>
                                        ...
                                        <div class="col-3">
                                          ...
                                          <input type="number" class="form-control form-control-sm price-input"  name="price[]" placeholder="Цена">
                                          @error('price[]')
                                              <span class="text-danger text-sm">{{ $message }}</span>
                                          @enderror
                                        </div>
                                        <div class="col-3">
                                          ...
                                          <input type="number" readonly class="form-control form-control-sm quantity-input"  name="quantity[]" value="1" min="1">
                                          @error('quantity[]')
                                              <span class="text-danger text-sm">{{ $message }}</span>
                                          @enderror
                                        </div>
                  ...
                  if (e.target.classList.contains('product-select')) {
                      ...
                      if (productId) {
                          ...
                          .then(data => {
                              ...
                              if(data.product_type == 'barcode'){
                                barcodeInput.style.display='block';
                                quantityInput.readOnly =true;
                              }else if(data.product_type == 'no_barcode'){
